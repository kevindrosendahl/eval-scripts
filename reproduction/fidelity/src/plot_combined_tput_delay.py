'''
Combine throughput and delay logs from multiple subdirectories of fidelity/data.
Then plot combined data together.
'''
...
parser = argparse.ArgumentParser(description='Combine throughput/delay data of different runs and plot')
