...
'''
Plot average cwnd for multiple iterations of ccp and kernel.
Also plot histogram of cwnd's logged by ccp and kernel.

Since cwnd log times vary, we bucket cwnd values for average plot
in small dt bucket.
'''
