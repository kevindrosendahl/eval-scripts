...
sudo ${DIR}/../../generic-cong-avoid/target/release/cubic --ipc=netlink --deficit_timeout=20 > ~/crash-cubic-ccp.log 2>&1 &
...
iperf -c localhost -p 4242 -Z ccp 2>&1 | tee ~/crash-iperf-client.log
